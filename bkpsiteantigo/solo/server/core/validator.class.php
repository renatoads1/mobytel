...
class Validator
{
    ...
    function init_error_messages()
    {
        ...
        $error_messages['required'] = Language::get('validation.required');
        $error_messages['min_length'] = Language::get('validation.min_length');
        $error_messages['max_length'] = Language::get('validation.max_length');
        $error_messages['exact_length'] = Language::get('validation.exact_length');
        $error_messages['valid_email'] = Language::get('validation.valid_email');
        $error_messages['valid_url'] = Language::get('validation.valid_url');
        $error_messages['numeric'] = Language::get('validation.numeric');
        $error_messages['alpha'] = Language::get('validation.alpha');
        $error_messages['alpha_numeric'] = Language::get('validation.alpha_numeric');
        $error_messages['valid_date'] = Language::get('validation.valid_date');
        $error_messages['valid_state'] = Language::get('validation.valid_state');
        $error_messages['valid_zip'] = Language::get('validation.valid_zip');
        $error_messages['valid_phone'] = Language::get('validation.valid_phone');
        $error_messages['matches'] = Language::get('validation.matches');
        $error_messages['min'] = Language::get('validation.min');
        $error_messages['max'] = Language::get('validation.max');
        $error_messages['strong_password'] = Language::get('validation.strong_password');
