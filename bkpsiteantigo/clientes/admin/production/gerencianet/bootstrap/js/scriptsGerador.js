...
$(document).ready(function(){
    ...
    $("#btn_emitir_boleto_gerador").load(function (){
		 if($('#form')[0].checkValidity()) {
			 
         $("#myModal").modal('show');
         $("#boleto").addClass("hide");
         var cliente = $("#cliente").val();
         var caixapostal = $("#caixapostal").val();
		 ...
		 console.log(parseInt(valor))
		  ...
		  data:{cliente:cliente,caixapostal:caixapostal,descricao:descricao,valor:valor,quantidade:quantidade,nome_cliente:nome_cliente,cpf:cpf,telefone:telefone,vencimento:vencimento},
		  type:'post',
		  dataType:'json',
