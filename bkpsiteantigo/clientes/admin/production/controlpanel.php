        ...
        <div class="right_col" role="main">
         <!-- top tiles -->
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-money"></i> Gastos / Mês Atual R$</span>
              <div class="count"> 
			   <?php 
			   
			   if($gastosmes['gastos'] != Null){
			  	
			   		echo substr($gastosmes['gastos'],0,-4 );
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-money"></i> Valor Atual /Mês  R$ </span>
              <div class="count green"> <?php echo substr($registros['credit'],0,-2 ); ?></div>
            
            </div>
            <div class="pull-right">
	           
	            <button type="button" class="btn btn-info btn-sm">2º Via de Conta</button>
	            <button type="button" class="btn btn-info btn-sm">Gerar Boleto</button>
	            <button type="button" class="btn btn-info btn-sm">Informar Pagamento</button>
	            <button type="button" class="btn btn-info btn-sm">Comprar Crédito</button>
	             <button type="button" class="btn btn-info btn-sm">Gerar NF</button>
