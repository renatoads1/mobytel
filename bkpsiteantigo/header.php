      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li class="scroll"><a href="http://mobytel.com.br/loja">Loja</a></li>
             <li class="scroll"><a href="planos.php">Planos</a></li>
            ...
            <li class="scroll"><a href="contato.php">Fale Conosco</a></li>       
          </ul>
        </div>
      </div>
    </div><!--/#main-nav-->
