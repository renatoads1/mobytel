	     ...
	     <div class="container">   
	        <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
	            <div id="controle-ligamos" class="col-md-8  hidden-xs hidden-sm hidden-md">     
	                <iframe src="http://192.168.0.22/mbilling/index.php/call0800Web?user=2000" frameborder="0" scrolling="NO" width="100%" height="30px"  ;></iframe>	                   
	            </div>
	            <div  class="col-sm-8 hidden-lg" >
              		 <iframe id="framecallback"  src="http://192.168.0.22/mbilling/index.php/call0800Web?user=2000" frameborder="0" scrolling="NO" width="100%" height="auto" align="right";  ></iframe>               	
        		</div>
	            <div class="col-md-4">
	                <div class="row">
	                    <div class="col-md-6" > 
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li class="scroll"><a href="como-funciona.php">Como Funciona</a></li>               
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="about-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            ...
            <p align="center">Atuamos no ramo de tecnologia ligada a telecomunicações. Provemos serviços de telefonia por IP com o intuito de aproximar as pessoas e dinamizar a comunicação. Acreditamos que facilitando a comunicação estamos aproximando as pessoas e construindo um mundo melhor.</p>
            <h2 align="center">Missão</h2>
            <p align="center">Sabemos que a telecomunicação aproxima as pessoas, amplia os negócios e facilita a vida das pessoas. E essa é nossa paixão. Por isso, temos como missão a qualidade, economia, eficiência e a inovação. Sempre pensando em você.</p>
          </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="text-center wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
             <a href="http://192.168.0.11:8080/mobytelwebsite/loja/"><button type="button" class="btn btn-primary btn-lg" style="font-size: 2vw !important;" >Clique aqui e acesse nossa loja</button></a>  
        </div>
      </div>
       <br />
       <br />
        ...
        <div class="row">
          <div class="col-sm-8 col-sm-offset-2">
            <div class="twitter-icon text-center">
              <span><i class="fa fa-comments" aria-hidden="true" style="font-size: 700%; color:#f27935;"></i></span>
            </div>
            <div id="twitter-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="item active wow fadeIn" data-wow-duration="2000ms" data-wow-delay="300ms">
                  <h4>Ipec Brasil Pesquisas e Relacionamento</h4>
                  <p>O melhor serviço de voip que trabalhamos até hoje. Ligação limpa e clara. Uso em todo meu call center.<br /><span style="font-size: 12px;">Samuel Siqueira - Diretor Geral</span></p>
                </div>
                <div class="item">
                 <h4>Telefone Móvel</h4>  
                  <p>Tenho no meu celular e uso muito. Qualidade muito boa e ligações ilimitadas.<br /><br /><span style="font-size: 12px;">Felipe - Desenvolvedor Web</span></p>
                </div>
                <div class="item">                           
                 <h4>Residêncial</h4>     
                  <p>Coloquei em minha casa e fiquei surpreso. O audio é melhor que das operadoras convencionais e economizei R$ 230,00 por mês em minha conta de telefone. <br /><span style="font-size: 12px;">Fausto Tadeu - Proprietário</span></p>
                </div>
              </div>                        
            </div>                    
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <h2>Fale Conosco</h2>
            <p>Temos uma equipe treinada para melhor atende-lo. Entre em contato conosco para tirar dúvidas, reclamações, esclarecimentos, opiniões, orçamentos ou qualquer que seja o motivo. Estaremos aguardando ansiosamente seu contato. Iremos responder o mais rápido possível. </p>
          </div>
        </div>
          ...
          <div class="row">
                ...
                <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <input type="text" name="name" class="form-control" placeholder="Digite seu Nome" required="required" style="border-color:white !important;">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control" placeholder="Digite seu Email " required="required" style="border-color:white !important;">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <input type="text" name="subject" class="form-control" placeholder="Digite o Assunto" required="required" style="border-color:white !important;">
                </div>
                <div class="form-group">
                  <textarea name="message" id="message" class="form-control" rows="4" placeholder="Digite sua mensagem" required="required" style="border-color:white !important;"></textarea>
                </div>                        
                <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                <p><strong>Moby Soluções Tecnológicas em Telecomunicações Ltda.</strong></p>
                <ul class="address">
                   <li><i class="fa fa-phone"></i> (31) 2512-6331 </li>
                   <li><i class="fa fa-envelope"></i><a href=""> atendimento@mobytel.com.br</a></li>
                 </ul>
              </div>                            
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-sm-8">
            <p>&copy; 2016 - Desenvolvido por Moby Telecomunicações - Todos os direitos reservados</p>
          </div>
        </div>
      </div>
    </div>
